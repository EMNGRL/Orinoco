/*! For license information please see tutorial.7a700fa607834376c329.js.LICENSE.txt */
...
let f, g, m, v = n.classList.contains("language-javascript"), b = n.classList.contains("language-markup"), y = +e.getAttribute("data-trusted"), E = !+e.getAttribute("data-no-strict") && v ? '"use strict";' : "", w = 'globalThis.__codeBoxId = "'.concat(e.id, '";'), _ = "".concat(E, "\n\n").concat(d);
d = "".concat(E).concat(w, "\n\n").concat(d);
let S = !0;
if (!v && !b) return;
let k = e.querySelector('[data-action="run"]');
...
function L() {
t && (t.remove(), t = null), v ? x() : function() {
let t;
...
S && e.hasAttribute("data-autorun") || a(m) || m.scrollIntoView(!1);
} else {
...
n.remove(), S && e.hasAttribute("data-autorun") || (t.onload = function() {
...
//# sourceMappingURL=tutorial.7a700fa607834376c329.js.map